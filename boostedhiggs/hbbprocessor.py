    ...
    def __init__(self, year='2017', jet_arbitration='pt'):
        ...
        self._accumulator = processor.dict_accumulator({
            ...
            'templates1': hist.Hist(
                ...
                hist.Bin('n2ddt1', r'Jet 1 N2ddt value', 10, -0.25, 0.25),        
            ),
            'templates2': hist.Hist(
                'Events',
                hist.Cat('dataset', 'Dataset'),
                hist.Cat('region', 'Region'),
                hist.Bin('pt2', r'Jet 2 $p_{T}$ [GeV]', [200, 250, 300, 350, 400, 450, 500, 550, 600, 675, 800, 1200]),
                hist.Bin('msd2', r'Jet 2 $m_{sd}$', 40, 40, 200),
                hist.Bin('ddb2', r'Jet 2 ddb score', 20, 0, 1),
                hist.Bin('n2ddt2', r'Jet 2 N2ddt value', 20, -0.25, 0.25),
                hist.Bin('ddb1', r'Jet 1 ddb score', [0, 0.89, 1]),
            ),
            'templates3': hist.Hist(
                ...
                hist.Bin('mjj', r'$m_{jj}$', 100, 0, 4000),
                hist.Bin('qgl1', r'Thin jet 1 qgl', 10, 0, 1),
                hist.Bin('qgl2', r'Thin jet 2 qgl', 10, 0, 1),
                hist.Bin('ddb1', r'Jet 1 ddb score', [0, 0.89, 1]),
            ),
            'templates4': hist.Hist(
                'Events',
                hist.Cat('dataset', 'Dataset'),
                hist.Cat('region', 'Region'),
                hist.Bin('nfatjets', 'Number of fat jets', 10,0,10),
                hist.Bin('njets', 'Number of thin jets', 12,0,12),
                hist.Bin('ddb1', r'Jet 1 ddb score', [0, 0.89, 1]),
            ),
...
#                hist.Cat('systematic', 'Systematic'),
    ...
    def process(self, events):
        ...
        if self._jet_arbitration == 'pt':
            ...
            raise RuntimeError("Unknown candidate jet arbitration for second jet")
...
#            'btagEffStatDown',
        ...
        def fill(region, systematic, wmod=None):
            ...
            output['templates4'].fill(
                dataset=dataset,
                region=region,
                nfatjets=nfatjets[cut],
                njets=njets[cut],
                ddb1=normalize(candidatejet.btagDDBvL, cut),
                weight=weight,
            )
